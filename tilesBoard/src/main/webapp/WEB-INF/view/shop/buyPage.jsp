...
<body>
			...
			<div class="panel-heading">
				<div class="panel panel-default">
					<div class="panel-body"
						...
						<div class="row">
							<div class="col-md-12">
								<h2 style="margin-top: 5px;">ORDER INFORMATION</h2>
							</div>
						</div>
					</div>
					<!-- 제목 패널 끝 -->
									...
									<table class="table table-striped">
										...
										<tbody>
											<tr>
												...
												<td class="goodsPriceTd">${goodsDetail.goodsPrice }</td>
												<td>${goodsDetail.goodsPoint }</td>
												<td><input type="number" name="orderGoodsCnt" class="buyCnt" value="${cnt }" min="1" style="width: 70%; text-align: center;"></td>
												<td>${goodsDetail.goodsDeliveryPrice }</td>
												<td class="price">${goodsDetail.goodsPrice * cnt + goodsDetail.goodsDeliveryPrice }원</td>
											</tr>
										</tbody>
									</table>
								</div>
							...
							<div class="panel-body">
								<div class="form-horizontal text-right">
									<h4>
										...
										<span style="font-weight: bold; color: red;" class="totalPrice">${goodsDetail.goodsPrice * cnt + goodsDetail.goodsDeliveryPrice }</span>
	...
	<script src="resources/js/buyPage.js?ver=4"></script>
</body>
</html>