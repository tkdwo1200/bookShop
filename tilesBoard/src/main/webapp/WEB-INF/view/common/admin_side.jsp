...
<ul class="nav nav-pills nav-stacked">
  ...
  <li role="presentation" <c:if test="${memberVO.subMenu eq 'manageCategory' }">class="active"</c:if>><a href="manageCategory.ad?mainMenu=admin&subMenu=manageCategory">카테고리 관리</a></li>
