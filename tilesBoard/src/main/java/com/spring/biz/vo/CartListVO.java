...
public class CartListVO extends BaseVO{
	...
	public String toString() {
		return "CartListVO [goodsId=" + goodsId + ", cartId=" + cartId + ", fileName=" + fileName + ", goodsName="
				+ goodsName + ", memberId=" + memberId + ", memberName=" + memberName + ", createDate=" + createDate
				+ ", goodsPrice=" + goodsPrice + ", goodsCnt=" + goodsCnt + ", totalPrice=" + totalPrice
				+ ", goodsPoint=" + goodsPoint + ", goodsDeliveryPrice=" + goodsDeliveryPrice + "]";
	}
